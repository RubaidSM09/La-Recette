...
class ManageRecipeDetailsPage extends StatelessWidget {
  const ManageRecipeDetailsPage({super.key, required this.recipeId});
                ...
                children: [
                  ...
                  Center(
                    child: SizedBox(
                        ...
                        }, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFE85A4F)), child: const Text("Delete", style: TextStyle(color: TColors.dark),))
                    ),
                  ),
                  const SizedBox(height: TSizes.spaceBtwItems),
                ],
