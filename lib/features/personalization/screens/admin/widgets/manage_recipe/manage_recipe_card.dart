...
import 'package:t_store/features/personalization/screens/admin/widgets/manage_recipe/manage_recipe_details.dart';
...
class ManageRecipeCard extends StatelessWidget {
  const ManageRecipeCard({super.key, required this.recipe});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Get.to(() => ManageRecipeDetailsPage(recipeId: recipe.id,)),
      child: Container(
        width: 180,
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    //product name
                    TProductTitleText(title: recipe.title, smallSize: false),
                    const SizedBox(height: TSizes.spaceBtwItems / 2),
                    //brand name
