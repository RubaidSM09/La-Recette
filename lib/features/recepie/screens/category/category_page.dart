...
class CategorizedScreen extends StatelessWidget {
  const CategorizedScreen({super.key, required this.category});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TAppBar(
        title: Text(category.name, style: Theme.of(context).textTheme.headlineMedium!.apply(color: dark ? TColors.dark : const Color(0xFFE85A4F))),
      ),
      ...
      body: SingleChildScrollView(
        child: Padding(
            ...
            child: FutureBuilder(
                  future: controller.fetchCategorizedRecipes(category.name),
